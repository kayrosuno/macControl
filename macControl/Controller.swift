...
//  macControl
//
//  Created by Alejandro Garcia on 11/3/24.
//
...
/**
    The Controller class implements the  functions of the app, including:
...
extension Controller: AppCommunication {
